...
ActiveRecord::Schema.define(version: 2019_12_06_120938) do

  create_table "fixed_cost_amounts", force: :cascade do |t|
  ...
  create_table "variable_cost_amounts", force: :cascade do |t|
